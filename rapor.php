      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Raporla</li>
          </ol>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['veliadi']);?></td>
                                            <td><?php echo htmlentities($row['odeme']);?></td>
                                            <td><?php echo htmlentities($row['guncellemeTarihi']);?></td>
                                            <td><?php echo htmlentities($row['ucret']);?></td>
                                            <td><?php echo htmlentities($row['kalan']);?></td>
                                            <td>
